...
/**
 * A 2D geometric point that usually represents the x, y coordinates. It can
 * also represent a relative magnitude vector's x, y magnitudes.
 * 
 * @since JavaFX 2.0
 */
public class Point2D {
    ...
    /**
     * Returns a string representation of this {@code Point2D}. This method is
     * intended to be used only for informational purposes. The content and format
     * of the returned string might vary between implementations. The returned
     * string might be empty but cannot be {@code null}.
     */
    @Override
